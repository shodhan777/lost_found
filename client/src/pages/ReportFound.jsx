...
const ReportFound = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert('Thank you for reporting! We will verify and match this item.');
            navigate('/found');
        } catch (err) {
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                            <div>
                                ...
                                <input type="text" name="name" value={formData.name} onChange={handleChange} required style={inputStyle} placeholder="e.g. Keys" />
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                <div>
                                    <label style={{ display: 'block', marginBottom: '0.5rem' }}>Date Found</label>
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: '0.5rem' }}>Location Found</label>
                        ...
                        <div>
                            ...
                            <textarea name="description" value={formData.description} onChange={handleChange} rows="4" style={inputStyle} placeholder="Details..."></textarea>
                        </div>
